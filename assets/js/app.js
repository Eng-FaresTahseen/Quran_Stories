const stories = {
        ...
        slides: [
            {
                ...
                text: 'منذ ولادته، أحاطت رعاية الله بموسى عليه السلام. فألهم الله أمه أن تضعه في تابوت وتلقيه في اليم لحمايته من بطش فرعون وجنوده.'
            },
            {
                image: 'assets/images/musa_2.png', // Reusing image
                text: 'ولما بلغ أشده، خرج إلى مدين وعاش فيها سنين. وفي طريق عودته، رأى ناراً عند جبل الطور، فكلمه الله تعالى واصطفاه بالنبوة وأيده بالمعجزات.'
            },
            {
                image: 'assets/images/musa_3.png',
                text: 'ذهب موسى لفرعون ليدعوه لتوحيد الله، وألقى عصاه فإذا هي ثعبان مبين ابتلع سحر السحرة، فخر السحرة ساجدين مؤمنين برب العالمين.'
            },
            {
                image: 'assets/images/red_sea_parting_1776769181782.png',
                text: 'عندما هرب موسى وقومه، تبعهم فرعون. وأمام البحر، أمر الله موسى أن يضرب بعصاه البحر، فانفلق العظيم ليصبح طريقاً يابساً لنجاتهم وهلاك فرعون.'
            }
        ],
        versesData: {
            surah: 'سورة الشعراء',
    ...
    yunus: {
        ...
        slides: [
            {
                image: 'assets/images/yunes_1.png',
                text: 'دعا يونس عليه السلام قومه في نينوى إلى الإيمان بالله، فلما أصروا على الكفر، غضب منهم وخرج من المدينة دون أن ينتظر أمر ربه.'
            },
            {
                image: 'assets/images/yunus_stormy_ship_1776786893629.png',
                text: 'ركب يونس سفينة مشحونة، فهاج البحر وكادت تغرق. فاقترعوا ليلقوا أحدهم في البحر لتخفيف الحمولة، فوقعت القرعة عليه، فألقى نفسه في الأمواج المتلاطمة.'
            },
            {
                image: 'assets/images/yunus_whale_deep_1776787088546.png',
                text: 'أمر الله حوتاً عظيماً أن يبتلعه. وفي ظلمات البحر وبطن الحوت، نادى يونس ربه معترفاً بذنبه: "لا إله إلا أنت سبحانك إني كنت من الظالمين".'
            },
            {
                image: 'assets/images/yunus_shore_gourd_1776787370332.png',
                text: 'استجاب الله نداءه المخلص، ولفظه الحوت على الشاطئ حياً، وأنبت الله عليه شجرة يقطين لحمايته وتغذيته، ليعود إلى قومه برسالة التوحيد.'
            }
        ],
        versesData: {
            surah: 'سورة الصافات',
    ...
    yusuf: {
        ...
        slides: [
            {
                image: 'assets/images/yusuf_1.jpeg',
            ...
            {
                image: 'assets/images/yusuf_4.png',
    ...
    ibrahim: {
        ...
        slides: [
            {
                image: 'assets/images/ibrahim_1.png',
            ...
            {
                image: 'assets/images/ibrahim_2.png',
            ...
            {
                image: 'assets/images/ibrahim_3.png',
            ...
            {
                image: 'assets/images/ibrahim_4.png',
    ...
    maryam: {
        ...
        slides: [
            {
                image: 'assets/images/maryam_1.png',
            ...
            {
                image: 'assets/images/maryam_2.png',
            ...
            {
                image: 'assets/images/maryam_3.png',
            ...
            {
                image: 'assets/images/maryam_4.png',
